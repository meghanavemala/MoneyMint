...
export function DashboardHeader() {
  return (
    <header className="bg-background/95 sticky top-0 z-30 flex h-14 items-center gap-4 border-b px-4 backdrop-blur-sm">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-semibold">Sandeep Finance</h1>
      </div>
